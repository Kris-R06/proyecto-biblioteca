...
route::middleware(['auth', 'user_type:admin'])->group(function () {
    ...
    Route::get('/categorias/{id}/delete', [CategoriasController::class, 'delete_confirm'])->name('categorias.delete_confirm');
    ...
    Route::get('/libros/{id}/delete', [LibrosController::class, 'delete_confirm'])->name('libros.delete_confirm');
    ...
    Route::get('/prestamos/{id}/delete', [PrestamosController::class, 'delete_confirm'])->name('prestamos.delete_confirm');
